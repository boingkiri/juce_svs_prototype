...
class KeyboardComponent : public juce::KeyboardComponentBase,
...
public:
    ...
    */
    void setKeyPressForNote(const juce::KeyPress& key, int midiNoteOffsetFromC);
    ...
    */
    virtual void drawWhiteNote(int midiNoteNumber, juce::Graphics& g, juce::Rectangle<float> area,
    ...
    /** Use this method to draw a black note of the keyboard in a given rectangle.
        ...
        When doing this, be sure to note the keyboard's orientation.
    */
    virtual void drawBlackNote(int midiNoteNumber, juce::Graphics& g, juce::Rectangle<float> area,
    ...
    */
    virtual bool mouseDownOnKey(int midiNoteNumber, const juce::MouseEvent& e) { juce::ignoreUnused(midiNoteNumber, e); return true; }
    ...
    /** Callback when the mouse is dragged from one key onto another.
        ...
        @see mouseDownOnKey
    */
    virtual bool mouseDraggedToKey(int midiNoteNumber, const juce::MouseEvent& e) { juce::ignoreUnused(midiNoteNumber, e); return true; }

    /** Callback when the mouse is released from a key.

        @see mouseDownOnKey
    */
    virtual void mouseUpOnKey(int midiNoteNumber, const juce::MouseEvent& e) { juce::ignoreUnused(midiNoteNumber, e); }
    ...
    */
    virtual juce::String getWhiteNoteText(int midiNoteNumber);
    ...
    juce::Range<float> getKeyPosition(int midiNoteNumber, float targetKeyWidth) const;
    juce::Rectangle<float> getRectangleForKey(int note) const;
    float getKeyWidthModifier(int midiNoteNumber) const;
    juce::Range<float> getKeyPosRevised(int midiNoteNumber) const;

    float getKeyWidth() { return keyWidth; }


private:
    //==============================================================================
    void drawKeyboardBackground(juce::Graphics& g, juce::Rectangle<float> area) override final;
    void drawWhiteKey(int midiNoteNumber, juce::Graphics& g, juce::Rectangle<float> area) override final;
    void drawBlackKey(int midiNoteNumber, juce::Graphics& g, juce::Rectangle<float> area) override final;
    ...
    void updateNoteUnderMouse(const juce::MouseEvent&, bool isDown);
